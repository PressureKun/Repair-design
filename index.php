...
<body>
  ...
  <main>
    <section class="hero">
      ...
      <div class="container hero__container">
        <div class="content hero__content">
          ...
          <div class="button-box hero__button-box">
            <button class="button hero__button_1 button--primary" data-toggle="modal">Рассчитать стоимость</button>
            <button class="button hero__button_2 button--outline">Отправить заявку</button>
          </div>
        </div>
        <!-- /.hero__content -->
      </div>
        ...
        <div class="row">
          <div class="col-50">
            <div class="section-title section-title--left">
              <h2 class="section-title__heading section-title__heading--projects  section-title__heading--primary">
                Завершённые <span class="section-title__word">проекты</span>
              </h2>
              <!-- Section title heading -->
              <p class="section-title__text">На сайте представлена ​​лишь небольшая часть работ, выполняемых нашей
                компанией. За 14
                лет работы на строительном рынке мы осчастливили более 1000 семей</p>
            </div>
            ...
            <div class="swiper-container">
              ...
              <div class="swiper-wrapper swiper-no-swiping">
                ...
                <div class="swiper-slide">
                  ...
                  <div class="swiper-slide__text">
                    <h3 class="swiper-slide__heading">Плошадь:</h3>
                    <span class="swiper-slide__value">Ростов-на-дону</span>
                  </div>
                  <div class="swiper-slide__text">
          ...
          <div class="col-50">
            ...
            <div class="swiper-container">
              ...
              <div class="swiper-wrapper swiper-no-swiping">
                <!-- Slides -->
                <div class="swiper-slide"><img src="img/projects_1.jpg" alt=""></div>
                <div class="swiper-slide"><img src="img/projects_1.jpg" alt=""></div>
                <div class="swiper-slide"><img src="img/projects_1.jpg" alt=""></div>
                <div class="swiper-slide"><img src="img/projects_1.jpg" alt=""></div>
              </div>
    ...
    <section class="section control">
      <div class="container">
        <div class="section-title section-title--light control__section-title">
          <h2 class="section-title__heading">Онлайн контроль</h2>
          <div class="section-title__image"><img src="img/video.svg" alt=""></div>
        </div>
        <div class="control__video video">
          <img src="img/play.svg" alt="" class="video__play wow pulse" data-wow-iteration="5">
        </div>
        <p class="control__text">На каждом объекте установлена ​​камера, которая транслирует ход работы на часах. В
          любой момент вы можете зайти на наш
          сайт и следить за ходом работы в вашей квартире. Посмотрите прямую трансляцию с одного из наших объектов!
          Оставьте
        ...
        <form action="#" class="form control__form">
          <div class="control__input-group">
            ...
            <input type="text" class="input form__input control__input input--dark" id="user-name"
              placeholder="Как вас зовут:">
          </div>
          <div class="control__input-group">
            <label for="user-phone" class="label form__label control__label">Телефон</label>
            <input type="tel" class="input form__input control__input input--dark" id="user-phone"
          ...
          <div class="policy control__policy">
            ...
            <label for="policy-checkbox" class="policy__label control__policy-label">Я соглашаюсь с обработкой
              данных</label>
          </div>
        </form>
      </div>
    ...
    <section class="section types">
      <div class="container types__container">
        <div class="section-title types__section-title">
          ...
          <div class="section-title__image"><img src="img/types.svg" alt=""></div>
        </div>
        <!-- section title -->
        <div class="row">
          <div class="col-30">
            <div class="card types__card">
              <img src="/img/type_1.jpg" alt="" class="card__image">
              <div class="card__text wow fadeInUp" data-wow-delay="0.1s">
                <h3 class="card__title">Косметичекий ремонт</h3>
                <!-- /.card__title -->
                <ul class="card__list">
                ...
                <strong class="card__pricetag">от 900 руб / м <sup>2</sup></strong>
                <!-- /.card__list -->
              </div>
              <!-- /.card__text -->
            </div>
          ...
          <div class="col-30">
            <div class="card types__card">
              <img src="/img/type_2.jpg" alt="" class="card__image">
              <div class="card__text wow fadeInUp" data-wow-delay="0.1s">
                ...
                <strong class="card__pricetag">от 1800 руб /м <sup>2</sup></strong>
                <!-- /.card__list -->
              </div>
              <!-- /.card__text -->
            </div>
          ...
          <div class="col-30">
            <div class="card types__card">
              <img src="/img/type_3.jpg" alt="" class="card__image">
              <div class="card__text wow fadeInUp" data-wow-delay="0.1s">
                ...
                <strong class="card__pricetag">от 4000 руб / м <sup>2</sup></strong>
                <!-- /.card__list -->
              </div>
              <!-- /.card__text -->
            </div>
    ...
    <div class="section design">
      <div class="container design-container">
        <div class="section-title design__section-title">
          ...
          <div class="section-title__image"><img src="img/design.svg" alt=""></div>
          <p class="section-title__description">Дизайн-проект не только помогает сделать ремонт вашей квартиры более
            современным, но и значительно удешевляет материалы
        ...
        <div class="row">
          <div class="col-30">
            <div class="card design__card">
              <img src="/img/design_1.jpg" alt="" class="card__image">
              <div class="card__text wow fadeInUp" data-wow-delay="0.1s">
                ...
                <strong class="card__pricetag">150 руб / м <sup>2</sup></strong>
                <!-- /.card__list -->
              </div>
              <!-- /.card__text -->
            </div>
          ...
          <div class="col-30">
            <div class="card design__card">
              <img src="/img/design_2.jpg" alt="" class="card__image">
              <div class="card__text wow fadeInUp" data-wow-delay="0.1s">
                ...
                <strong class="card__pricetag">400 руб / м <sup>2</sup></strong>
                <!-- /.card__list -->
              </div>
              <!-- /.card__text -->
            </div>
          ...
          <div class="col-30">
            <div class="card design__card">
              <img src="/img/design_3.jpg" alt="" class="card__image">
              <div class="card__text wow fadeInUp" data-wow-delay="0.1s">
                <h3 class="card__title">Дизайнерский ремонт</h3>
                <!-- /.card__title -->
                <ul class="card__list">
                ...
                <strong class="card__pricetag">900 руб / м <sup>2</sup></strong>
                <!-- /.card__list -->
              </div>
              <!-- /.card__text -->
            </div>
    ...
    <div class="section team">
      <div class="container team-container">
        <div class="section-title team__section-title">
          ...
          <div class="section-title__image"><img src="img/team.svg" alt=""></div>
          <p class="section-title__description section-title__description--team">Наша команда помогла стать счастливее
            более чем 500 семьям, и мы не
            собираемся останавливаться</p>
          <!-- /.section-title__description -->
        </div>
        <!-- section title -->
        <div class="row">
          <div class="col-30">
            <div class="team-card">
              <div class="button team__button button--primary wow fadeInLeft">
                <img src="/img/team_icon_1.svg" alt="" class="team-card__icon">
              </div>

              <img src="/img/team_1.jpg" alt="" class="team-card__image">
              <div class="team-card__text wow fadeInUp" data-wow-delay="0.1s">
                <h3 class="team-card__title">Алексей Колмаков</h3>
                <!-- /.card__title -->

                <span class="team-card__description">Проектный менеджер</span>
                <!-- /.card__description -->

                <strong class="team-card__pricetag">ОПыт работы 8 лет</strong>
                <!-- /.card__list -->
              </div>
              <!-- /.card__text -->
            </div>
          ...
          <div class="col-30">
            <div class="team-card">
              <div class="button team__button button--primary wow fadeInLeft">
                <img src="/img/team_icon_2.svg" alt="" class="team-card__icon">
              </div>

              <img src="/img/team_2.jpg" alt="" class="team-card__image">
              <div class="team-card__text wow fadeInUp" data-wow-delay="0.1s">
                <h3 class="team-card__title">Алиса Сухорукова</h3>
                <!-- /.card__title -->

                <span class="team-card__description">Дизайнер</span>
                <!-- /.card__description -->

                <strong class="team-card__pricetag">ОПыт работы 6 лет</strong>
                <!-- /.card__list -->
              </div>
              <!-- /.card__text -->
            </div>
          ...
          <div class="col-30">
            <div class="team-card">
              <div class="button team__button button--primary wow fadeInLeft">
                <img src="/img/team_icon_3.svg" alt="" class="team-card__icon">
              </div>

              <img src="/img/team_3.jpg" alt="" class="team-card__image">
              <div class="team-card__text wow fadeInUp" data-wow-delay="0.1s">
                <h3 class="team-card__title">Давид Волынев</h3>
                <!-- /.card__title -->
                <div class="team-card__description">Бригадир</div>
                <!-- /.card__description -->
                <strong class="team-card__pricetag">ОПыт работы 7 лет</strong>
                <!-- /.card__list -->
              </div>
              <!-- /.card__text -->
            </div>
        ...
        <div class="section-footer">
          <p class="section-footer__description">Каждый сотрудник нашей компании является квалифицированным штатным
            специалистом с опытом работы от 6 лет. У нас нет
            гастарбайтеров, каждый сотрудник выполняет работу, соответствующую его специальности.</p>
        </div>
        <!-- section footer -->
      </div>
      <!-- /.container -->
    ...
    <div class="section client">
      <div class="container clients-container">
        <div class="section-title client__section-title">
          <h2 class="section-title__heading">Наши клиенты</h2>
          <div class="section-title__image"><img src="img/clients_icon.svg" alt=""></div>
          <p class="section-title__description section-title__description--client">80% наших клиентов рекомендуют нас своим знакомым и друзьям</p>
          <!-- /.section-title__description -->
        </div>
        <!-- section title -->
        <div class="row">
          <div class="col-30">
            <card class="client-card">
              <div class="client-card__group">
                <img src="/img/clients_img.png" alt="" class="round">
                <h3 class="client-card__title">Савельева Екатерина Львовна</h3>
              </div>
              <div class="client-card__text">
                Я хочу поблагодарить ребят за их работу. Они вложили душу в ремонт. Я очень благодарна, что сделали как для самих себя.
                Большое спасибо, я выражаю проектному менеджеру за его профессионализм и подход. Процесс ремонта был завершен быстрее,
                чем ожидалось. Команда мобильная и профессиональная. Работы выполнены качественно без нареканий. Цены демократические. Я
                рекомендую этих мастеров.
              </div>
              <div class="client-card__footer">
                <div class="client-card__pricetag">
                  <img src="/img/clients_day.svg" alt="" class="price-icon">
                  <span class="client-card__price-text">40 м<sup>2</sup></span>
                </div>
                <div class="client-card__pricetag">
                  <img src="/img/clients_m.svg" alt="" class="price-icon">
                  <span class="client-card__price-text">48 дней</span>
                </div>
              </div>
            </card>
          </div>
          <div class="col-30">
            <card class="client-card">
              <div class="client-card__group">
                <img src="/img/clients_img_2.png" alt="" class="round">
                <h3 class="client-card__title">Большов Михаил Анатольевич</h3>
              </div>
              <div class="client-card__text">
                Я хочу поблагодарить ребят за их работу. Они вложили душу в ремонт. Я очень благодарен, что сделали как для самих себя.
                Большое спасибо, я выражаю проектному менеджеру за его профессионализм и подход. Процесс ремонта был завершен быстрее,
                чем ожидалось. Команда мобильная и профессиональная. Работы выполнены качественно без нареканий. Качество высокое.  Я
                рекомендую этих мастеров.
              </div>
              <div class="client-card__footer">
                <div class="client-card__pricetag">
                  <img src="/img/clients_day.svg" alt="" class="price-icon">
                  <span class="client-card__price-text">90м<sup>2</sup></span>
                </div>
                <div class="client-card__pricetag">
                  <img src="/img/clients_m.svg" alt="" class="price-icon">
                  <span class="client-card__price-text">128 дней</span>
                </div>
              </div>
            </card>
          </div>
          <div class="col-30">
            <card class="client-card">
              <div class="client-card__group">
                <img src="/img/clients_img_3.png" alt="" class="round">
                <h3 class="client-card__title">Хасанов Даниил Муратович</h3>
              </div>
              <div class="client-card__text">
                Я хочу поблагодарить ребят за их работу. Они вложили душу в ремонт. Я очень благодарен, что сделали как для самих себя.
                Большое спасибо, я выражаю проектному менеджеру за его профессионализм и подход. Процесс ремонта был завершен быстрее,
                чем ожидалось. Команда мобильная и профессиональная. Работы выполнены качественно без нареканий. Качество высокое. Цены
                демократические.
              </div>
              <div class="client-card__footer">
                <div class="client-card__pricetag">
                  <img src="/img/clients_day.svg" alt="" class="price-icon">
                  <span class="client-card__price-text">56 м<sup>2</sup></span>
                </div>
                <div class="client-card__pricetag">
                  <img src="/img/clients_m.svg" alt="" class="price-icon">
                  <span class="client-card__price-text">86 дней</span>
                </div>
              </div>
            </card>
          </div>
